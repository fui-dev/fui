...
class _FilePickerControlState extends State<FilePickerControl>
  ...
  Widget build(BuildContext context) {
    ...
    return withPageArgs((context, pageArgs) {
      ...
      if (_upload != upload && upload != null && _files != null) {
        _upload = upload;
        uploadFiles(
            upload, fuiAppServices.of(context).server, pageArgs.pageUri!);
      }
  ...
  Future uploadFiles(String filesJson, fuiServer server, Uri pageUri) async {
  ...
  Future uploadFile(PlatformFile file, fuiServer server, String uploadUrl,
      String method) async {
  ...
  void sendProgress(
      fuiServer server, String name, double? progress, String? error) {
    widget.backend.triggerControlEvent(
        widget.control.id,
        "upload",
