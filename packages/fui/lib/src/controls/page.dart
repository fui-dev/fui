...
import 'package:fui/src/models/page_args_model.dart';
import 'package:fui/src/utils/locale.dart';
...
import '../actions.dart';
import '../fui_app_context.dart';
import '../fui_app_services.dart';
import '../fui_control_backend.dart';
...
class _PageControlState extends State<PageControl> with fuiStoreMixin {
  bool? _adaptive;
  ...
  void _routeChanged() {
    widget.dispatch(SetPageRouteAction(
        _routeState.route, fuiAppServices.of(context).server));
  }
  ...
  Widget build(BuildContext context) {
    ...
    // clear hrefs index
    fuiAppServices.of(context).globalKeys.clear();
    ...
    _themeMode = ThemeMode.values.firstWhereOrNull((t) =>
        ...
        fuiAppContext.of(context)?.themeMode;
  ...
  Widget _buildNavigator(
    ...
    return StoreConnector<AppState, RoutesViewModel>(
        ...
        builder: (context, routesView) {
          ...
          var hideLoadingPage =
              fuiAppServices.of(context).hideLoadingPage ?? false;
...
class _ViewControlState extends State<ViewControl> with fuiStoreMixin {
