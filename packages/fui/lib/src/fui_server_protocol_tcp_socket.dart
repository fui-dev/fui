...
class fuiTcpSocketServerProtocol implements fuiServerProtocol {
  String address;
  fuiServerProtocolOnMessageCallback onMessage;
  fuiServerProtocolOnDisconnectCallback onDisconnect;
  Socket? _socket;
  late final bool _isLocalConnection;
  late final int _defaultReconnectIntervalMs;

  fuiTcpSocketServerProtocol(
