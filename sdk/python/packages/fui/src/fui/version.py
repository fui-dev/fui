"""Provide the current fui version."""
...
import fui
from fui.utils import is_mobile, is_windows, which
...
def update_version():
    ...
    os.chdir(Path(fui.__file__).absolute().parent)
    in_repo = (
    ...
    if in_repo:
        ...
        if "cannot describe anything" in err:
            ...
            msg += "If so please clone the original fui repo"
