...
from fui.core.exceptions import fuiUnsupportedPlatformException
...
class WebView(ConstrainedControl):
    ...
    View docs: [WebView](https://fui.dev/docs/controls/webview)
    """
    ...
    def _check_mobile_or_mac_platform(self):
        ...
        if self.page.platform not in [
            ...
            raise fuiUnsupportedPlatformException(
