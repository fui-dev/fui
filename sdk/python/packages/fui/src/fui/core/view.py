...
from fui.core.navigation_drawer import NavigationDrawer
from fui.core.scrollable_control import OnScrollEvent, ScrollableControl
...
class View(ScrollableControl, AdaptiveControl):
    ...
    A root view is automatically created when a new user session started. From layout perspective the View represents a `Column`(https://fui.dev/docs/controls/column/) control, so it has a similar behavior and shares same properties.

    -----

    Online docs: https://fui.dev/docs/controls/view
    """
