...
from fui.core.animation import AnimationValue
from fui.core.autofill_group import AutofillHint
from fui.core.badge import BadgeValue
from fui.core.border import Border
from fui.core.box import BoxShadow, DecorationImage
from fui.core.control import Control, OptionalNumber
from fui.core.gradients import Gradient
from fui.core.ref import Ref
from fui.core.text_style import StrutStyle, TextStyle
from fui.core.textfield import InputFilter, KeyboardType, TextCapitalization, TextField
from fui.core.tooltip import TooltipValue
...
class CupertinoTextField(TextField):
    ...
    Online docs: https://fui.dev/docs/controls/cupertinotextfield
    """
