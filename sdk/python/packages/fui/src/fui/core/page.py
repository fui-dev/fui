...
from fui.core.alignment import Alignment
from fui.core.animation import AnimationCurve
...
from fui.core.box import BoxDecoration
from fui.core.client_storage import ClientStorage
from fui.core.connection import Connection
...
from fui.core.event_handler import EventHandler
from fui.core.floating_action_button import FloatingActionButton
from fui.core.locks import NopeLock
from fui.core.navigation_bar import NavigationBar
from fui.core.navigation_drawer import NavigationDrawer, NavigationDrawerPosition
from fui.core.padding import Padding
from fui.core.protocol import Command
...
from fui.core.session_storage import SessionStorage
from fui.core.snack_bar import SnackBar
from fui.core.theme import Theme
...
from fui.utils import classproperty, deprecated, is_pyodide
...
_session_page = ContextVar("fui_session_page", default=None)
...
try:
    from fui.auth.authorization import Authorization
    from fui.auth.oauth_provider import OAuthProvider
...
class Page(AdaptiveControl):
    """
    Page is a container for `View` (https://fui.dev/docs/controls/view) controls.
    ...
    Online docs: https://fui.dev/docs/controls/page
    """
    ...
    def login(
        ...
        if saved_token is None:
            ...
            if on_open_authorization_url:
                ...
                self.launch_url(
                    authorization_url, "fui_oauth_signin", web_popup_window=self.web
                )
        else:
