...
from fui.core.ads.base_ad import BaseAd
from fui.core.animation import AnimationValue
from fui.core.control import OptionalNumber
from fui.core.ref import Ref
from fui.core.types import OffsetValue, ResponsiveNumber, RotateValue, ScaleValue
...
class NativeAd(BaseAd):
    ...
    Online docs: https://fui.dev/docs/controls/nativead
    """
