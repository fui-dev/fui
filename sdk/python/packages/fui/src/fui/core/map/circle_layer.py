...
from fui.core.types import ColorEnums, ColorValue
...
class CircleMarker(Control):
    ...
    Online docs: https://fui.dev/docs/controls/mapcirclemarker
    """
...
class CircleLayer(MapLayer):
    ...
    Online docs: https://fui.dev/docs/controls/mapcirclelayer
    """
