...
from fui.core.map.map import MapLatitudeLongitude
from fui.core.map.map_layer import MapLayer
from fui.core.ref import Ref
from fui.core.text_style import TextStyle
from fui.core.types import ColorEnums, ColorValue, StrokeCap, StrokeJoin
...
class PolygonMarker(Control):
    ...
    Online docs: https://fui.dev/docs/controls/mappolygonmarker
    """
...
class PolygonLayer(MapLayer):
    ...
    Online docs: https://fui.dev/docs/controls/mappolygonlayer
    """
