...
from fui.core.map.map import MapLatitudeLongitudeBounds
from fui.core.map.map_layer import MapLayer
from fui.core.ref import Ref
from fui.core.types import OptionalControlEventCallable
...
class TileLayer(MapLayer):
    ...
    Online docs: https://fui.dev/docs/controls/maptilelayer
    """
