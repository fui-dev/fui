...
from fui.core.box import BoxConstraints
from fui.core.buttons import OutlinedBorder
...
from fui.core.textfield import KeyboardType, TextCapitalization
...
from fui.utils import deprecated
...
class SearchBar(ConstrainedControl):
    ...
    Online docs: https://fui.dev/docs/controls/searchbar
    """
