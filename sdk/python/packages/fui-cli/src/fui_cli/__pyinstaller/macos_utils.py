...
from fui.utils import safe_tar_extractall
...
def unpack_app_bundle(tar_path):
    ...
    return os.path.join(bin_dir, "fui.app")


def update_fui_view_icon(app_path, icon_path):
    print("Updating fui View icon", app_path, icon_path)
...
def update_fui_view_version_info(
    app_path,
    bundle_id,
    product_name,
    product_version,
    ...
    print("Updating fui View plist", app_path)
