...
class Command(BaseCommand):
    """
    Create a new fui app from a template.
    """
    ...
    def add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            "--project-name",
            dest="project_name",
            help="project name for the new fui app",
            required=False,
        )
        parser.add_argument(
            "--description",
            dest="description",
            help="the description to use for the new fui project",
            required=False,
        )
        parser.add_argument(
            "--template",
            ...
            choices=["default"],
            default="default",
            help="template to use for new fui project",
            required=False,
        )
        parser.add_argument(
            "--package-manager",
        ...
        parser.add_argument(
            ...
            dest="template_ref",
            type=str,
            help="the branch, tag or commit ID to checkout after cloning the repository with fui app templates",
        )
    ...
    def handle(self, options: argparse.Namespace) -> None:
        ...
        template_data = {
            ...
            "fui_version": fui.version.version,
        }

        template_ref = options.template_ref
        if not template_ref and fui.version.version:
            template_ref = version.Version(fui.version.version).base_version
        ...
        try:
            cookiecutter(
                f"gh:fui-dev/fui-app-templates",
        ...
        console.print(f"fui run {app_dir}\n")
