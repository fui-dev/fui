...
from fui.utils import is_pyodide
...
class fuiAppManager:
    ...
    def __init__(self):
        ...
        self.__temp_dirs = {}
        self.__executor = ThreadPoolExecutor(thread_name_prefix="fui_fastapi")
    ...
    async def start(self):
        ...
        if not self.__evict_sessions_task:
            logger.info("Starting up fui App Manager")
    ...
    async def shutdown(self):
        """
        Cleanup temporary fui resources on application shutdown.
        """
        logger.info("Shutting down fui App Manager")
