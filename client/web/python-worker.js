...
self.fui_js = {}; // namespace for Python global functions

self.initPyodide = async function () {
    self.pyodide = await loadPyodide();
    self.pyodide.registerJsModule("fui_js", fui_js);
    fui_js.documentUrl = documentUrl;
  ...
  `);
    ...
    await self.fui_js.start_connection(self.receiveCallback);
